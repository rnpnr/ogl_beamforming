...
upload_settings(WorkContext *wc)
{
	...
	if (do_fft) shader_stages[shader_stage_count++] = ComputeShaderKind_DecodeFloatComplex;
	...
	if (wc->bp.output_points[3] > 1) shader_stages[shader_stage_count++] = ComputeShaderKind_Sum;
