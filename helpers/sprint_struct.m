function str = sprint_struct(s, indentation, element_prefix, element_suffix)
    ...
    % TODO(rnp): This won't handle structs containing structs. This doesn't
    % matter for C-structs because matlab cannot handle nested C-structs.
    fields = fieldnames(s);
    values = struct2cell(struct(s));
