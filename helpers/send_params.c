...
main(i32 argc, char *argv[])
{
	...
	if (!strcmp(argv[1], "params")) {
		...
		//i32 stages[] = {CS_HADAMARD, CS_HERCULES, CS_MIN_MAX};
		i32 stages[] = {CS_HADAMARD, CS_UFORCES, CS_SUM, CS_MIN_MAX};
		set_beamformer_pipeline(OS_SMEM_NAME, stages, ARRAY_COUNT(stages));
